...
<head>
    ...
    <!-- Meta Description -->
    <meta name="description" content="{{ !empty($article->description) ? Str::limit(strip_tags($article->description), 150) : 'Senior Laravel Developer with 15+ years of experience. Expert in SaaS architecture, AWS, and fintech payment gateway integrations (Casys, Halkbank).' }}">
